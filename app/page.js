...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-black via-gray-900 to-purple-600 text-white">
      <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 md:translate-x-[10%] text-center md:left-10 md:top-1/2 md:-translate-y-1/2 md:text-left animate-fade-in w-[90%] md:w-auto">
